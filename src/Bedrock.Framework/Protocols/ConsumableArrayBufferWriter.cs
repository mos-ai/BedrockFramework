...
namespace Bedrock.Framework.Protocols
{
    internal class ConsumableArrayBufferWriter : IBufferWriter<byte>, IDisposable
    {
        ...
        /// </summary>
        public ReadOnlyMemory<byte> WrittenMemory => _buffer.AsMemory(_consumedCount, _index - _consumedCount);

        /// <summary>
        /// Returns the unconsumed data written to the underlying buffer so far, as a <see cref="ReadOnlySpan{byte}"/>.
        /// </summary>
        public ReadOnlySpan<byte> WrittenSpan => _buffer.AsSpan(_consumedCount, _index - _consumedCount);
